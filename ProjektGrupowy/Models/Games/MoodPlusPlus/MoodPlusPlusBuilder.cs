...
{
    public class MoodPlusPlusBuilder
    {
        public MoodPlusPlusBuilder() { }

        private MoodPlusPlus matrix;
        ...
        private void BuildBoard()
        {
            ...
            var coordinatesUp = new List<System.Drawing.Point> { new System.Drawing.Point(0, 0), new System.Drawing.Point(34, 0), new System.Drawing.Point(67, 0) };
            var coordinatesLo = new List<System.Drawing.Point> { new System.Drawing.Point(0, 50), new System.Drawing.Point(50, 50) };

            for (int i = 0; i < 3; i++)
            {
                originalityContainers[i] = new RegionContainer(coordinatesUp[i].X, coordinatesUp[i].Y, 33, 50, RegionContainer.OrientationType.VERTICAL);
            ...
            for (int i = 0; i < 2; i++)
            {
                originalityContainers[i] = new RegionContainer(coordinatesLo[i].X, coordinatesLo[i].Y, 50, 50, RegionContainer.OrientationType.VERTICAL);
                originalityContainers[i].SetAcceptElement(idea);
        ...
        public void Build()
        {
            matrix = new MoodPlusPlus();
            matrix.BackgorundImageId = images.AddImage("/Resources/Images/moodPP.png");
